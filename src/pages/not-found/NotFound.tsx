    ...
    return (
        <Box sx={{ width: '100%', height: '100vh', display: 'grid', placeItems: 'center', userSelect: 'none' }}>
            <Box sx={{ width: 'min-content', display: 'flex', flexDirection: 'column', justifyContent: 'center', }}>
                <Typography sx={{ color: '#ea0000', WebkitTextStroke: '1px white', fontSize: 200, fontWeight: 900, fontFamily: '"Fontdiner Swanky", sans-serif;', textAlign: 'center' }}>404</Typography>
